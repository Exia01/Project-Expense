...
import { ReportContext, Consumer } from "../../contexts/reportContext";
...
//   static contextType = ReportContext;
  ...
  render() {
    ...
    return (
        <ReportContext.Consumer>{ (reportContext) => {
            const { title, reason_for_travel, handleChange, handleSubmit } = reportContext;
